...
namespace Remtask.Controllers
{
    public class TarefasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("TarefaId,TituloTarefa,DiaTarefa,Horario")] Tarefa tarefa)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TarefaId,TituloTarefa,DiaTarefa,Horario")] Tarefa tarefa)
        {
